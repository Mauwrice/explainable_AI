...
def dir_setup(INPUTDIR, OUTPUTDIR,
              ...
              weight_mode = "avg", hm_type = "gc", ending = "_predcl"):
    ...
    if version.startswith("10Fold"):
        WEIGHT_DIR = INPUTDIR + "weights/" + version + "/"
        DATA_OUTPUT_DIR = OUTPUTDIR + "pictures/" + version + "/"
        PIC_OUTPUT_DIR = OUTPUTDIR + "pictures/" + version + "/"
        pic_save_name = version + "_M" + str(model_version) + "_" + weight_mode + "_" + hm_type + ending
        
    elif version == "andrea":
        WEIGHT_DIR = INPUTDIR + "weights/andrea_split/"
        DATA_OUTPUT_DIR = OUTPUTDIR + "pictures/andrea_split/"
        PIC_OUTPUT_DIR = OUTPUTDIR + "pictures/andrea_split/"
        pic_save_name = "andrea_split_" + hm_type + ending
        
    return DATA_DIR, WEIGHT_DIR, DATA_OUTPUT_DIR, PIC_OUTPUT_DIR, pic_save_name
